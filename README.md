# Surface Rxy ZXY Analyzer V4.0.1

面型及 Rxy 分析工具当前稳定版本为 **V4.0.1**。GitHub `main` 根目录只保留当前版本的运行入口、模块、文档、测试和 Demo；旧版本文件统一放在 [`archive/legacy_versions`](archive/legacy_versions/README.md)。

## 当前版本入口

- `面型及Rxy分析工具V4.0.1.py`：V4.0.1 Python 启动入口。
- `start_surface_analyzer_v4_0_1.bat`：Windows 推荐启动脚本，自动创建并复用仓库内 `.venv`。
...
- [V4.0.1 接口文档](docs/V4.0.1_接口文档.md)
- [V4.0.1 模块架构](docs/V4.0.1_架构说明.md)
- [V4.0.1 本地测试清单](docs/V4.0.1_本地测试清单.md)
