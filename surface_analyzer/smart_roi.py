...
SENSITIVITY = {
    'strict': {'edge_factor': 1.55, 'residual_factor': 0.75, 'normal_deg': 5.0},
    'standard': {'edge_factor': 2.20, 'residual_factor': 1.00, 'normal_deg': 12.0},
    'loose': {'edge_factor': 3.00, 'residual_factor': 1.50, 'normal_deg': 24.0},
}
...
def grow_surface_roi(x, y, z, seed_x, seed_y, tolerance_mm, topology,
    ...
    while queue:
        ...
        for neighbor in adjacency[current]:
            ...
            if visited[neighbor]:
                continue
            predicted = current_plane[0] * x[neighbor] + current_plane[1] * y[neighbor] + current_plane[2]
